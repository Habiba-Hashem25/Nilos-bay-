...
const BASE_URL = "https://nilos-bay-mu.vercel.app";
...
export default function Home() {
  return (
    <>
      <PageMeta
        title="Nilos Bay — Nile-side Dining & Lifestyle in Dokki"
        description="Nilos Bay: 9 cafés, restaurants, bowling and Nile boats on the river in Dokki, Giza. Open 24/7."
        ogTitle="Nilos Bay — Nile-side Dining & Lifestyle in Dokki"
        ogDescription="9 cafés, restaurants, bowling and Nile boats in Dokki, Giza. Open 24/7."
        ogUrl={`${BASE_URL}/`}
        ogImage={`${BASE_URL}/og-home.jpg`}
        twitterTitle="Nilos Bay — Nile-side Dining & Lifestyle in Dokki"
        twitterDescription="9 cafés, restaurants, bowling and Nile boats in Dokki, Giza. Open 24/7."
        canonical={`${BASE_URL}/`}
        jsonLd={{
          ...
          name: "Nilos Bay",
          description:
            "Nile-side dining and lifestyle mall in Dokki, Giza — cafés, restaurants, bowling and Nile boats.",
          url: `${BASE_URL}/`,
          telephone: "+201064011110",
          address: {
            "@type": "PostalAddress",
            streetAddress: "26J9+CFQ, Ad Doqi A",
          ...
          sameAs: ["https://www.instagram.com/inlanebowlingnilos"],
        }}
      />
          ...
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-gradient-gold px-7 py-3.5 text-base font-semibold text-primary-foreground shadow-gold hover:scale-[1.01] transition cursor-pointer disabled:opacity-70 disabled:hover:scale-100"
              >
                {status === "loading" ? (
                  <>
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 grid sm:grid-cols-2 gap-4">
          ...
          <InfoCard
            icon={MessageCircle}
            title="Contact Us"
            lines={["WhatsApp", PHONE_DISPLAY]}
            cta="Chat on WhatsApp"
            href={`https://wa.me/2${PHONE}`}
          />
          <InfoCard
            icon={Instagram}
            title="Follow the Venues"
            lines={["9 venues on Instagram"]}
            cta="See the lineup"
            href="#tenants"
          />
        </div>
